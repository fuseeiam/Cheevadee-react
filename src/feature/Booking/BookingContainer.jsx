...
export default function BookingContainer() {
    return (
        <div>
            {/* standard 1 */}
            <div>
                <div className="bg-[#21395D] flex justify-center px-40 py-20">
         ...
         focus:ring-[#C18638] focus:border-[#BD7416 flex ">
                        <div className="flex flex-col items-start">
                            <div>
                                <h1 className="flex justify-start text-2xl font-light">STANDRAD ROOM</h1>
                            </div>
                            <div >
                            ...
                            <div className="flex py-1">
                                ...
                                <div className="flex px-5">
                                    ...
                                    <h2 className="text-[#63635D] px-2.5 py-0.5 font-light">2 Single Beds</h2>
                                </div>
                            </div>
                            <div className="flex py-1">
                        ...
                        <div className="flex flex-col px-5 flex-1 ">
                            ...
                            <div>
                                <button className="bg-[#C18638] hover:bg-[#BD7416] text-white text-xl py-2.5 w-300 rounded-md text-center font-li">
                                    RESERVE
                                </button>
                            </div>
                        </div>
