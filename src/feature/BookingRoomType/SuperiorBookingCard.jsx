        ...
        <div>
         ...
         focus:ring-[#C18638] focus:border-[#BD7416 flex ">
                        <div className="flex flex-col items-start">
                            ...
                            <div >
                                <img src="/src/assets/room-superior-8.jpeg" alt="" className="py-5 w-[600px] h-[400px]" />
                            </div>
                            ...
                            <div className="flex py-1">
                                ...
                                <h2 className="text-[#63635D]  px-2.5 py-0.5 font-light">Room size: 32 m²/344 ft²</h2>
                            </div>
                            <div className="flex py-1">
         ...
         focus:ring-[#C18638] focus:border-[#BD7416 flex ">
                        <div className="flex flex-col items-start">
                            ...
                            <div >
                                <img src="/src/assets/room-superior-1.jpeg" alt="" className="py-5 w-[600px] h-[400px]" />
                            </div>
                            <div className="flex py-1">
                                <div className="flex">
                                    <img src="/src/icons/person-50.png" alt="" className="w-[30px] h-[30px]" />
