    ...
    <div className="bg-[#21395D] flex justify-center px-40 py-10">
      <div className="bg-white w-full rounded-md p-5 outline-none border border-gray-300 flex ">
        <div className="flex flex-col items-start">
          <div>
            <h1 className="flex justify-start text-2xl font-light">{roomtype}</h1>
          </div>
          <div >
            <img src={picture} alt="" className="py-5 w-[600px] h-[400px]" />
          </div>
          ...
          <div className="flex py-1">
            ...
            <h2 className="text-[#63635D]  px-2.5 py-0.5 font-light">Room size: {roomSize}</h2>
          </div>
          <div className="flex py-1">
